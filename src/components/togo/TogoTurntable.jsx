...
import {
  buildTogoGroup, setupTogoStage, disposeGroup, makeFabricMaps, fabricAnisotropy, STANDARD_TOGO_FINISH,
} from './togoSceneBuilder.js';
import { loadFabricAppearance, makeAppearanceCache, disposeAppearanceCache } from './togoFabricAppearance.js';
...
export default function TogoTurntable({ scene3d, fabricByCode, className = '', onStatus }) {
  ...
  useEffect(() => {
    ...
    const rebuild = async (eng) => {
      ...
      const group = buildTogoGroup(deps, { pieces }, {
