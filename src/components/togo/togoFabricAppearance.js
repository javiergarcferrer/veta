/**
 * Resolve ONE fabric code into the three.js appearance `buildTogoGroup` wants:
 * `{ color, texture, normal, pbr }`.
 *
 * This is the single-code port of the live stage's texture pipeline (TogoStage's
