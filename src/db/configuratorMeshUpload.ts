...
export async function uploadConfiguratorMesh(file: File): Promise<string> {
...
export async function removeConfiguratorMesh(url: string | null | undefined): Promise<void> {
  const marker = `/${BUCKET}/`;
