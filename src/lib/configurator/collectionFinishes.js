 ...
 * palette rides that AND a READ-TIME INJECTION: `resolveConfiguratorModels`
 ...
 *  `resolveConfiguratorModelCards` projects, so a card and its raw row can never land
 ...
 * palette the moment the group is marked, and `resolveConfiguratorModels` INJECTS it at
