 ...
 */
// veta: the LR grade ladder lives in the brand's own module — the permanent
// divergence the README names (upstream reads it from lib/subtype).
import { LR_ALPHA_GRADES as ALPHA_GRADES } from '../brands/ligne-roset/catalogGrammar.js';
import { BRAND_LIGNE_ROSET } from './constants.js';
