...
// 1 world unit (configuratorView PX_PER_CM = 1, TogoStage.buildScene). A
...
// (buildShare), the 3D render (togoSceneBuilder.buildRoomGroup) and the fit
// readout. tests/togoRoom.test.js pins the geometry.
