 ...
 * no page chrome of its own (ConfiguratorWorkspace owns the header + tabs); admin-only.
 */
...
export default function ConfiguratorDealers() {
  ...
  const resolvedById = useMemo(
    () => resolveConfiguratorModels(models, products).resolvedById,
    [models, products],
  );
