/**
 * SERVER TWIN of src/lib/lrEtiquetteDiff.ts — the «Étiquette» CHANGE LOG
 * reader, for the Deno side of the wall.
 *
 * Byte-identical to its Vite original (this module imports nothing, so there is
 * not even a constant to inline). Pinned by tests/lrEtiquetteParity.test.js.
