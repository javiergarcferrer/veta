...
import {
  ...
  COLLECTION_MAX_POOL,
} from '../src/lib/configurator/modelMatch.js';
import { BILLED_ROLES } from '../src/lib/configurator/meshParts.js';
...
test('decompose: the caps hold and the roles are the billable ones', () => {
  ...
  // (lib/configurator/catalogDecompose in RosetSoft), so the wall-mirror comparison
